package com.android.andryyu.mdsdk.utils.exception;
...
import com.android.andryyu.mdsdk.utils.ToastUtils;
...
public class AppCrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private AppCrashHandler instance;
     ...
     */
    public AppCrashHandler getInstance() {
        if (instance == null) {
    ...
    public void handleException(Throwable throwable) {
        ...
        ToastUtils.showInThread(context, String.format("%s\n%s", "很抱歉，程序遭遇异常，即将退出！", builder.toString()));
    }
