        ...
        switch (viewType) {
            case TYPE_ONE:
                return new NowWeatherViewHolder(
                    LayoutInflater.from(mContext).inflate(R.layout.item_weather_temperature, parent, false));
            case TYPE_TWO:
                return new HoursWeatherViewHolder(
                    LayoutInflater.from(mContext).inflate(R.layout.item_weather_hour_info, parent, false));
            case TYPE_THREE:
                return new SuggestionViewHolder(
                    LayoutInflater.from(mContext).inflate(R.layout.item_weather_suggestion, parent, false));
            case TYPE_FORE:
                return new ForecastViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_weather_forecast, parent, false));
        }
        return null;
    }
    ...
    private class HoursWeatherViewHolder extends BaseViewHolder<Weather> {
        ...
        HoursWeatherViewHolder(View itemView) {
            ...
            for (int i = 0; i < mWeatherData.hourlyForecast.size(); i++) {
                View view = View.inflate(mContext, R.layout.item_weather_hour_info_line, null);
    ...
    class ForecastViewHolder extends BaseViewHolder<Weather> {
        ...
        ForecastViewHolder(View itemView) {
            ...
            for (int i = 0; i < mWeatherData.dailyForecast.size(); i++) {
                View view = View.inflate(mContext, R.layout.item_weather_forecast_line, null);
