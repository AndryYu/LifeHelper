...
import com.android.andryyu.lifehelper.model.stayinline.StayInLineFragment;
...
import com.android.andryyu.lifehelper.model.ditowine.DitowineFragment;
...
public class MainActivity extends BaseActivity implements AMapLocationListener {
    ...
    private DitowineFragment homeFragment;
    private HaveFunFragment haveFunFragment;
    private FoodClothFragment foodClothFragment;
    private StayInLineFragment stayInLineFragment;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    ...
                    return true;
                case R.id.nav_video:
                    selectFragment(haveFunFragment);
                    return true;
                case R.id.nav_music:
                    selectFragment(foodClothFragment);
                    return true;
                case R.id.navigation_notifications:
                    selectFragment(stayInLineFragment);
                    return true;
    ...
    private void initFragment() {
        ...
        homeFragment = DitowineFragment.newInstance();
        haveFunFragment = HaveFunFragment.newInstance();
        foodClothFragment = FoodClothFragment.newInstance();
        stayInLineFragment = new StayInLineFragment();
        mineFragment = MineFragment.newInstance();
        mFrameList.add(homeFragment);
        mFrameList.add(foodClothFragment);
        mFrameList.add(haveFunFragment);
        mFrameList.add(stayInLineFragment);
